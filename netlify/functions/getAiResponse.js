...
exports.handler = async function (event, context) {
    ...
    try {
        ...
        4.  **If the user asks "how to" do something, you MUST format the answer as a clear, step-by-step numbered list.** Use bold formatting for key items or actions within the list.
